/*
problem: https://www.geeksforgeeks.org/batch/gfg-160-problems/track/two-pointer-technique-gfg-160/problem/count-all-triplets-with-given-sum-in-sorted-array
author: parag kumar goyal
TC: O(n^2) SC: O(1)
*/

class Solution {
    public long countTriplets(int[] arr, int target) {
        int n = arr.length;
        long res = 0;
